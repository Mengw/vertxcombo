...
public class AsyncFileTest extends TestVerticle {
	...
	public void testReadStream(){
		...
		vertx.fileSystem().open("some-file.dat", new AsyncResultHandler<AsyncFile>() {
		    public void handle(final AsyncResult<AsyncFile> ar) {
		        if (ar.succeeded()) {
		        	vertx.fileSystem().open("other-file.dat", null, false, true, true, true,new AsyncResultHandler<AsyncFile>(){
  ...
  public void testOther(){
	  ChainedFileHandler cfh = new ChainedFileHandler(vertx, "combined.txt", "a.txt","b.txt","c.txt");
  ...
  public void testOther1(){
	  ChainedFileHandler cfh = new ChainedFileHandler(vertx, "combined1.txt","c.txt","b.txt", "a.txt");
